...
// Inclua o cabeçalho do Emscripten
#include <emscripten.h>

// Função para salvar valores
void SaveStorageValue(int key, int value) {
    // Converte o valor para string e envia ao localStorage
    EM_ASM({
...
int LoadStorageValue(int key) {
    // Obtém o valor do localStorage (ou retorna 0 se não existir)
    return EM_ASM_INT({
